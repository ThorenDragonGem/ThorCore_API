...
public class UpdateChecker
{
	 ...
	 * Localized update messages can be disabled and the messages set manually, but localized is preferred.
	...
	/**
	 * Sets the update messages to be unlocalized.
...
class UpdateCheckerThread extends Thread {
	...
	private void sendMessage() {
		if(this.outOfDate) {
			LogHelper.info("The mod " + modId + " is out of date. The current version is " + this.VERSION + ", the newest version is " + this.NEWVERSION);
			String message;
			if(!this.unlocalised) {
			...
			LogHelper.info("The mod " + modId + " is up to date."); 
		}
	}
}