 ...
 */
public class ThorHoe extends ItemHoe
{
	private final ToolMaterial toolMaterial;
	private boolean hasToolTip = false;
	private boolean hasEffect = false;
	private Object effect[] = new Object[2];
	private static HashMap<String, List<ThorHoe>> hoeWithModIdMap = new HashMap<String, List<ThorHoe>>();
	 ...
	 */
	public ThorHoe(ToolMaterial toolMaterial)
	{
		super(toolMaterial);
	 ...
	 */
	public ThorHoe setItemName(String unlocalizedName)
	{
	 ...
	 * @return ThorHoe
	 */
	public ThorHoe addToolTip(String toolTip)
	{
	 ...
	 * @return ThorHoe
	 */
	public ThorHoe setRepairMaterial(ItemStack repairMaterial)
	{
		this.canRepair = true;
	 ...
	 * @return ThorHoe
	 */
	public ThorHoe modId(String modId)
	{
		List<ThorHoe> list = Lists.newArrayList();
		list.add(this);
		this.modId = modId;
	 ...
	 * @return ThorHoe
	 */
	public ThorHoe setEffect(Enchantment enchantment, int level)
	{
		this.hasEffect = true;
	 ...
	 * @return ThorHoe
	 */
	public ThorHoe setTab(CreativeTabs creativeTab)
	{
	...
	public static List<ThorHoe> getItemListFromModId(String modId)
	{
